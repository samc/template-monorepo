...
export type DocumentNode = PostsDocument | GlobalDocument | ThemeDocument | AuthorsDocument | PagesDocument;
...
export type ThemeColors = {
  ...
  stone: Scalars['String'];
  red: Scalars['String'];
  orange: Scalars['String'];
  amber: Scalars['String'];
  yellow: Scalars['String'];
  lime: Scalars['String'];
  green: Scalars['String'];
  emerald: Scalars['String'];
  teal: Scalars['String'];
  cyan: Scalars['String'];
  sky: Scalars['String'];
  blue: Scalars['String'];
  indigo: Scalars['String'];
  violet: Scalars['String'];
  purple: Scalars['String'];
  fuchsia: Scalars['String'];
  pink: Scalars['String'];
  rose: Scalars['String'];
};

export type ThemeSpaceObject = {
  __typename?: 'ThemeSpaceObject';
  _: Scalars['Float'];
  xs: Scalars['Float'];
  s: Scalars['Float'];
};
...
export type ThemeSpace = {
  __typename?: 'ThemeSpace';
  object?: Maybe<ThemeSpaceObject>;
  _: Scalars['Float'];
  xs: Scalars['Float'];
  s: Scalars['Float'];
  m: Scalars['Float'];
...
export type ThemeColorsMutation = {
  ...
  slate?: InputMaybe<Scalars['String']>;
  gray?: InputMaybe<Scalars['String']>;
  zinc?: InputMaybe<Scalars['String']>;
  neutral?: InputMaybe<Scalars['String']>;
  stone?: InputMaybe<Scalars['String']>;
  red?: InputMaybe<Scalars['String']>;
  orange?: InputMaybe<Scalars['String']>;
  amber?: InputMaybe<Scalars['String']>;
  yellow?: InputMaybe<Scalars['String']>;
  lime?: InputMaybe<Scalars['String']>;
  green?: InputMaybe<Scalars['String']>;
  emerald?: InputMaybe<Scalars['String']>;
  teal?: InputMaybe<Scalars['String']>;
  cyan?: InputMaybe<Scalars['String']>;
  sky?: InputMaybe<Scalars['String']>;
  blue?: InputMaybe<Scalars['String']>;
  indigo?: InputMaybe<Scalars['String']>;
  violet?: InputMaybe<Scalars['String']>;
  purple?: InputMaybe<Scalars['String']>;
  fuchsia?: InputMaybe<Scalars['String']>;
  pink?: InputMaybe<Scalars['String']>;
  rose?: InputMaybe<Scalars['String']>;
};

export type ThemeSpaceObjectMutation = {
  _?: InputMaybe<Scalars['Float']>;
  xs?: InputMaybe<Scalars['Float']>;
  s?: InputMaybe<Scalars['Float']>;
};

export type ThemeSpaceMutation = {
  object?: InputMaybe<ThemeSpaceObjectMutation>;
  _?: InputMaybe<Scalars['Float']>;
  xs?: InputMaybe<Scalars['Float']>;
  s?: InputMaybe<Scalars['Float']>;
  m?: InputMaybe<Scalars['Float']>;
  l?: InputMaybe<Scalars['Float']>;
  xl?: InputMaybe<Scalars['Float']>;
  xxl?: InputMaybe<Scalars['Float']>;
  xxxl?: InputMaybe<Scalars['Float']>;
};

export type ThemeMutation = {
  colors?: InputMaybe<ThemeColorsMutation>;
  space?: InputMaybe<ThemeSpaceMutation>;
};
...
export type LayoutQueryFragmentFragment = { __typename?: 'Query', getGlobalDocument: { __typename?: 'GlobalDocument', data: { __typename?: 'Global', header?: { __typename?: 'GlobalHeader', color?: string | null, icon?: { __typename?: 'GlobalHeaderIcon', name?: string | null, color?: string | null, style?: string | null } | null, nav?: Array<{ __typename?: 'GlobalHeaderNav', href?: string | null, label?: string | null } | null> | null } | null, footer?: { __typename?: 'GlobalFooter', color?: string | null, social?: { __typename?: 'GlobalFooterSocial', facebook?: string | null, twitter?: string | null, instagram?: string | null, github?: string | null } | null } | null, theme?: { __typename?: 'GlobalTheme', color?: string | null, icon?: string | null, font?: string | null, darkMode?: string | null } | null } } };

export type ThemeQueryFragmentFragment = { __typename?: 'Query', getThemeDocument: { __typename?: 'ThemeDocument', data: { __typename?: 'Theme', colors?: { __typename: 'ThemeColors', black: string, white: string, slate: string, gray: string, zinc: string, neutral: string, stone: string, red: string, orange: string, amber: string, yellow: string, lime: string, green: string, emerald: string, teal: string, cyan: string, sky: string, blue: string, indigo: string, violet: string, purple: string, fuchsia: string, pink: string, rose: string } | null, space?: { __typename: 'ThemeSpace', _: number, xs: number, s: number, m: number, l: number, xl: number, xxl: number, xxxl: number, object?: { __typename: 'ThemeSpaceObject', _: number, xs: number, s: number } | null } | null } } };

export type PageQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type PageQueryQuery = { __typename?: 'Query', getPostsList: { __typename?: 'PostsConnection', edges?: Array<{ __typename?: 'PostsConnectionEdges', node?: { __typename?: 'PostsDocument', id: string, values: any, data: { __typename?: 'Posts', author?: { __typename?: 'AuthorsDocument', data: { __typename?: 'Authors', avatar?: string | null, name?: string | null } } | null }, sys: { __typename?: 'SystemInfo', filename: string } } | null } | null> | null }, getThemeDocument: { __typename?: 'ThemeDocument', data: { __typename?: 'Theme', colors?: { __typename: 'ThemeColors', black: string, white: string, slate: string, gray: string, zinc: string, neutral: string, stone: string, red: string, orange: string, amber: string, yellow: string, lime: string, green: string, emerald: string, teal: string, cyan: string, sky: string, blue: string, indigo: string, violet: string, purple: string, fuchsia: string, pink: string, rose: string } | null, space?: { __typename: 'ThemeSpace', _: number, xs: number, s: number, m: number, l: number, xl: number, xxl: number, xxxl: number, object?: { __typename: 'ThemeSpaceObject', _: number, xs: number, s: number } | null } | null } }, getGlobalDocument: { __typename?: 'GlobalDocument', data: { __typename?: 'Global', header?: { __typename?: 'GlobalHeader', color?: string | null, icon?: { __typename?: 'GlobalHeaderIcon', name?: string | null, color?: string | null, style?: string | null } | null, nav?: Array<{ __typename?: 'GlobalHeaderNav', href?: string | null, label?: string | null } | null> | null } | null, footer?: { __typename?: 'GlobalFooter', color?: string | null, social?: { __typename?: 'GlobalFooterSocial', facebook?: string | null, twitter?: string | null, instagram?: string | null, github?: string | null } | null } | null, theme?: { __typename?: 'GlobalTheme', color?: string | null, icon?: string | null, font?: string | null, darkMode?: string | null } | null } } };
...
export type ThemePartsFragment = { __typename?: 'Theme', colors?: { __typename: 'ThemeColors', black: string, white: string, slate: string, gray: string, zinc: string, neutral: string, stone: string, red: string, orange: string, amber: string, yellow: string, lime: string, green: string, emerald: string, teal: string, cyan: string, sky: string, blue: string, indigo: string, violet: string, purple: string, fuchsia: string, pink: string, rose: string } | null, space?: { __typename: 'ThemeSpace', _: number, xs: number, s: number, m: number, l: number, xl: number, xxl: number, xxxl: number, object?: { __typename: 'ThemeSpaceObject', _: number, xs: number, s: number } | null } | null };

export type AuthorsPartsFragment = { __typename?: 'Authors', avatar?: string | null, name?: string | null };
...
export const ThemePartsFragmentDoc = gql`
  ...
  space {
    ...
    `;
export const ThemeQueryFragmentFragmentDoc = gql`
    fragment ThemeQueryFragment on Query {
  getThemeDocument(relativePath: "index.json") {
    data {
      ...ThemeParts
    }
  }
